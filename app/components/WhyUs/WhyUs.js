        ...
        <div className="container">
          <div className="flex flex-col items-center text-center lg:mb-[50px] mb-[30px]">
            <h2 className="section-title md:mb-[20px] mb-[10px]">
              <span className="font-normal">Warum verwenden</span> <br /> Handvenen-Biometrie?
            </h2>
            <p className="max-w-[830px]">Unsere Handvenen-Biometrie bietet mehrere Vorteile gegenüber herkömmlichen Authentifizierungsmethoden wie Passwörtern, PINs oder Fingerabdruck-Scans.</p>
          </div>
          <div className="grid lg:grid-cols-3 md:grid-cols-2 md:gap-[30px] gap-[20px]">
            ...
            <div className="bg-white py-[30px] px-[20px] rounded-[23px] text-center shadow-[0_30px_60px_rgba(0,0,0,0.05)]">
              ...
              <h3 className="xl:text-[30px] md:text-[24px] text-[20px] font-medium xl:mb-[30px] mb-[10px] leading-[1.3]">Hohe Sicherheit:</h3>
              <p>Handvenenmuster sind bei jedem Individuum einzigartig und praktisch unmöglich zu replizieren. Diese Einzigartigkeit bietet ein hohes Maß an Sicherheit gegen Identitätsdiebstahl und Betrug.</p>
            </div>
            {/* single box */}
            <div className="bg-white py-[30px] px-[20px] rounded-[23px] text-center shadow-[0_30px_60px_rgba(0,0,0,0.05)]">
              ...
              <p>Im Gegensatz zu Fingerabdruck- oder Iris-Scans ist die Handvenen-Authentifizierung nicht invasiv und erfordert keinen physischen Kontakt, was hygienischer und bequemer ist.</p>
            </div>
            {/* single box */}
            <div className="bg-white py-[30px] px-[20px] rounded-[23px] text-center shadow-[0_30px_60px_rgba(0,0,0,0.05)]">
              ...
              <p>Die Handvenen-Identifikationstechnologie ist gegen kompromittierende Umweltfaktoren wie Schmutz, Feuchtigkeit, Temperaturänderungen usw. unempfindlich und bietet hohe Genauigkeits- und Zuverlässigkeitsraten.</p>
            </div>
          </div>
        </div>
      </section>
